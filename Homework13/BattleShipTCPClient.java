...
/**
 * The class BattleShipTCPClient implements a version of two player
 * 3-dimensional BattleShip game using TCP socket connection.
 *
 * @author Rudram Joshi
...
public class BattleShipTCPClient {
    ...
    private static BufferedReader readFrom;
    private static PrintWriter writeTo;
     ...
     * This method safely closed the serverSocket if opened
     */
    ...
    /**
     * This method is invoked to initialize and setup the socket connection based on first(server)
     * and second(client)
     */
    ...
    /**
     * This method reads the oceans of the opposite player
     */
    private static void readTheOceans() {
        if ( first ) 		{
    ...
    /**
     * This method is used to send the data from the socket
    ...
    /**
     * This method returns the data by reading from the socket
